...
PC user console for the SDKWork AIoT product managed-device surface. Renders
managed device catalogs, local hardware state, capability coverage, and
peripheral readiness from the canonical `@sdkwork/aiot-app-sdk` resources.
...
- Domain: `device`
- Capability: `managed-device`
- Status: `ready`
- Supersedes: `@sdkwork/device-pc-react`
...
- `pnpm --filter @sdkwork/aiot-pc-console-device typecheck`
- `pnpm --filter @sdkwork/aiot-pc-console-device test`
