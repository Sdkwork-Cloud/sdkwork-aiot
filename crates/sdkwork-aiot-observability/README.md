# sdkwork-aiot-observability

Domain: intelligence
Capability: aiot-observability
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-aiot-observability`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
