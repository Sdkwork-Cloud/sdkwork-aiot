...
This directory is the local SDKWork component contract for `@sdkwork/aiot-backend-sdk`.

- Component root: `skdwork-aiot/sdks/sdkwork-aiot-backend-sdk/sdkwork-aiot-backend-sdk-typescript`
