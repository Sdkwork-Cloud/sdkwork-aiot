...
Domain: intelligence
Capability: aiot-backend-sdk
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/aiot-backend-sdk`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
