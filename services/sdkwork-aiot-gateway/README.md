...
Domain: intelligence
Capability: aiot-gateway
Package type: web-backend-service
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-aiot-gateway`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
