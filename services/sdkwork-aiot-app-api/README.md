...
Domain: intelligence
Capability: aiot-app-api
Package type: web-backend-service
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-aiot-app-api`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
