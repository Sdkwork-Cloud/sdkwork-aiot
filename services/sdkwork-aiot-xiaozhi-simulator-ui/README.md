# sdkwork-aiot-xiaozhi-simulator-ui

Domain: intelligence
Capability: aiot-xiaozhi-simulator-ui
Package type: web-backend-service
Status: standard

This README is the SDKWork module entrypoint for `sdkwork-aiot-xiaozhi-simulator-ui`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
